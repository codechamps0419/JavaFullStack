...
public class UArrays
{
 public static void main(String[] args) 
 {
  ...
  System.out.println( Arrays.toString(arr1));//toString() converts the array into a String
  ...
  Arrays.parallelSort(arr1); //uses the next cpu core
  ...
  int indx = Arrays.binarySearch(arr1, 4);//search for val 4 in arr1, returns indx or a negative value
